...
SECRET_KEY = 'django-insecure-9&p$rmy^u2tf$w6@ho!$8ixf)5otc9)1c@5rk!emong)o(!12&'
...
# DATABASES = {
#     'default': {
#         'ENGINE': 'sql_server.pyodbc',  # Specify the engine for SQL Server
#         'NAME': 'mybillbo_property',    # The database name
#         'USER': 'property_1',           # Your database user
#         'PASSWORD': 'Swiftdev@123',     # Your password
#         'HOST': '190.92.174.109',       # Your server IP
#         'PORT': '4096',                 # Your port
#         'OPTIONS': {
